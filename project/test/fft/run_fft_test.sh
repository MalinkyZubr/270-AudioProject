...
iverilog -g2012 -o ./bin/fft_breakdown ./fft_breakdown_test.sv ../../hdl/fft/**.sv &> ./logs/breakdown.log
iverilog -g2012 -o ./bin/butterfly ./butterfly_unit_test.sv ../../hdl/fft/**.sv &> ./logs/buttefly.log
